namespace GXPEngine.Scenes
{
    class SelectSongMenu : Scene
    {
        ...
        public SelectSongMenu(SceneManager sceneManager, SFX sfx)
        {
            ...
            buttons[0] = new Button("Art/Buttons/song_1_button.png", this.sceneManager, SceneManager.Scenes.DifficultyScene, SFX.Songs.Song1, true);
            buttons[0].SetOrigin(buttons[0].width / 2, buttons[0].height / 2);
            buttons[0].SetXY(game.width / 2, game.height / 5);
            AddChild(buttons[0]);

            buttons[1] = new Button("Art/Buttons/song_2_button.png", this.sceneManager, SceneManager.Scenes.DifficultyScene, SFX.Songs.Song2, false);
            buttons[1].SetOrigin(buttons[1].width / 2, buttons[1].height / 2);
            buttons[1].SetXY(game.width / 2, 2 * game.height / 5);
            AddChild(buttons[1]);

            buttons[2] = new Button("Art/Buttons/song_3_button.png", this.sceneManager, SceneManager.Scenes.DifficultyScene, SFX.Songs.Song3, false);
            buttons[2].SetOrigin(buttons[2].width / 2, buttons[2].height / 2);
            buttons[2].SetXY(game.width / 2, 3 * game.height / 5);
            AddChild(buttons[2]);

            buttons[3] = new Button("Art/Buttons/back_button.png", this.sceneManager, SceneManager.Scenes.MainMenu, SFX.Songs.MenuSong, false);
